...
async function seed() {
  ...
  await pool.query(`
    ...
    VALUES
      ('Smart Home Hub', 'A centralized smart home controller that connects all your IoT devices. Features voice control, automation routines, and energy monitoring. Compatible with Alexa, Google Home, and HomeKit.', 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=800', 'user_mock_1', NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days'),
      ...
      ('FitPod Earbuds', 'Wireless earbuds designed for athletes. Features heart rate monitoring, workout tracking, and adaptive noise cancellation. IPX7 waterproof with 12-hour battery life.', 'https://images.unsplash.com/photo-1590658268037-6bf12f032f55?w=800', 'user_mock_2', NOW() - INTERVAL '12 hours', NOW() - INTERVAL '12 hours'),
